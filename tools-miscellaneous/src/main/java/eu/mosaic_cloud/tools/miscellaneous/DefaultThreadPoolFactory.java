			...
			ThreadFactory
{
	...
	{
		return (new DefaultThreadPoolFactory (owner, daemon, priority, eu.mosaic_cloud.tools.exceptions.tools.UncaughtExceptionHandler.create (exceptionTracer)));
	}
	...
	{
		return (new DefaultThreadPoolFactory (owner, true, Thread.NORM_PRIORITY, eu.mosaic_cloud.tools.exceptions.tools.UncaughtExceptionHandler.create (exceptionTracer)));
	}
