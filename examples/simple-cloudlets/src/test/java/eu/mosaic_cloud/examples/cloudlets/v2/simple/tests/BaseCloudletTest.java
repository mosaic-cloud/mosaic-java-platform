			...
			extends eu.mosaic_cloud.platform.implementation.v2.cloudlets.tests.BaseCloudletTest<BaseCloudletTest.Scenario<?>>
{
	...
	protected <Context> void setUp (final Class<? extends CloudletCallback<Context>> callbacksClass, final Class<Context> contextClass, final String configuration) {
		...
		}
		{
			...
			final PropertiesBackedConfigurationSource driverConfiguration = PropertiesBackedConfigurationSource.create ();
			driverConfiguration.overridePropertyValue ("interop.driver.endpoint", scenario.driversEndpoint);
			driverConfiguration.overridePropertyValue ("interop.driver.identity", scenario.driversIdentity);
			driverConfiguration.overridePropertyValue ("amqp.host", host);
			driverConfiguration.overridePropertyValue ("amqp.port", port.toString ());
			driverConfiguration.overridePropertyValue ("amqp.driver_threads", Integer.toString (1));
			driverConfiguration.overridePropertyValue ("consumer.amqp.queue", "tests.queue");
			driverConfiguration.overridePropertyValue ("consumer.amqp.consumer_id", "tests.consumer");
			driverConfiguration.overridePropertyValue ("consumer.amqp.auto_ack", Boolean.toString (false));
			driverConfiguration.overridePropertyValue ("consumer.amqp.exclusive", Boolean.toString (false));
			driverConfiguration.overridePropertyValue ("publisher.amqp.exchange", "tests.exchange");
			driverConfiguration.overridePropertyValue ("publisher.amqp.routing_key", "tests.routing-key");
			driverConfiguration.overridePropertyValue ("publisher.amqp.manadatory", Boolean.toString (true));
			driverConfiguration.overridePropertyValue ("publisher.amqp.immediate", Boolean.toString (false));
			driverConfiguration.overridePropertyValue ("publisher.amqp.durable", Boolean.toString (false));
		...
		}
		{
			...
			driverConfiguration.overridePropertyValue ("interop.driver.endpoint", scenario.driversEndpoint);
			driverConfiguration.overridePropertyValue ("interop.driver.identity", scenario.driversIdentity);
			driverConfiguration.overridePropertyValue ("kvstore.host", host);
			driverConfiguration.overridePropertyValue ("kvstore.port", port.toString ());
			driverConfiguration.overridePropertyValue ("kvstore.driver_name", "RIAKREST");
			driverConfiguration.overridePropertyValue ("kvstore.driver_threads", Integer.toString (1));
			driverConfiguration.overridePropertyValue ("kvstore.bucket", "tests");
