...
import eu.mosaic_cloud.core.ops.GenericOperation;
import eu.mosaic_cloud.core.ops.IOperation;
...
final class AmqpOperationFactory implements IOperationFactory { // NOPMD by georgiana on 10/12/11 4:13 PM
	 ...
	 * 
	 * @see
	 * eu.mosaic_cloud.core.IOperationFactory#getOperation(eu.mosaic_cloud.core.IOperationType ,
	 * java.lang.Object[])
	 */
	@Override
