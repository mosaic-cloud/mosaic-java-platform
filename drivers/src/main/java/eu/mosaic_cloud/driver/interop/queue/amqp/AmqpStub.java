 ...
 * #L%
 */
package eu.mosaic_cloud.driver.interop.queue.amqp; // NOPMD by georgiana on 10/12/11 3:32 PM
...
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.Ack;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.BindQueueRequest;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.CancelRequest;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.ConsumeRequest;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.DeclareExchangeRequest;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.DeclareQueueRequest;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.GetRequest;
import eu.mosaic_cloud.interop.idl.amqp.AmqpPayloads.PublishRequest;
