 ...
 * #L%
 */
package eu.mosaic_cloud.driver.interop.kvstore.memcached; // NOPMD by georgiana on 10/12/11 2:55 PM
...
import eu.mosaic_cloud.driver.kvstore.memcached.MemcachedDriver;
...
import eu.mosaic_cloud.interop.idl.kvstore.MemcachedPayloads.AddRequest;
import eu.mosaic_cloud.interop.idl.kvstore.MemcachedPayloads.AppendRequest;
import eu.mosaic_cloud.interop.idl.kvstore.MemcachedPayloads.CasRequest;
import eu.mosaic_cloud.interop.idl.kvstore.MemcachedPayloads.PrependRequest;
import eu.mosaic_cloud.interop.idl.kvstore.MemcachedPayloads.ReplaceRequest;
