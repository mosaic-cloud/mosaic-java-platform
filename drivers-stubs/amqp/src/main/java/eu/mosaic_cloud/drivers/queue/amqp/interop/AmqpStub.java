			...
			extends AbstractDriverStub
{
	 ...
	 */
	private AmqpStub (final ConfigurationSource config, final ResponseTransmitter transmitter, final IResourceDriver driver, final ZeroMqChannel commChannel) {
	 ...
	 */
	public static AmqpStub create (final ConfigurationSource config, final ZeroMqChannel channel, final ThreadingContext threading) {
		synchronized (AbstractDriverStub.MONITOR) {
	...
	public static AmqpStub createDetached (final ConfigurationSource config, final ZeroMqChannel channel, final ThreadingContext threading) {
		synchronized (AbstractDriverStub.MONITOR) {
			final AmqpResponseTransmitter transmitter = new AmqpResponseTransmitter ();
			final AmqpDriver driver = AmqpDriver.create (config, threading);
