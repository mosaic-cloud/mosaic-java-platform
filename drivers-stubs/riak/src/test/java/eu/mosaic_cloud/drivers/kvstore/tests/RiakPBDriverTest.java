...
public class RiakPBDriverTest
{
			...
			throws Exception
	{
		...
		final String host = System.getProperty (RiakPBDriverTest.MOSAIC_RIAK_HOST, RiakPBDriverTest.MOSAIC_RIAK_HOST_DEFAULT);
		final Integer port = Integer.valueOf (System.getProperty (RiakPBDriverTest.MOSAIC_RIAK_PORT, RiakPBDriverTest.MOSAIC_RIAK_PORT_DEFAULT));
	...
	public void testDelete ()
	{
		...
		final IResult<Boolean> r1 = this.wrapper.invokeDeleteOperation (RiakPBDriverTest.keyPrefix, k1, handler1);
		try {
		...
		final IResult<byte[]> r3 = this.wrapper.invokeGetOperation (RiakPBDriverTest.keyPrefix, k1, handler3);
		try {
				...
				ClassNotFoundException
	{
		...
		final IResult<byte[]> r1 = this.wrapper.invokeGetOperation (RiakPBDriverTest.keyPrefix, k1, handler);
		try {
	...
	public void testList ()
	{
		...
		final IResult<List<String>> r1 = this.wrapper.invokeListOperation (RiakPBDriverTest.keyPrefix, handler);
		try {
			...
			throws IOException
	{
		...
		final IResult<Boolean> r1 = this.wrapper.invokeSetOperation (RiakPBDriverTest.keyPrefix, k1, b1, handler1);
		...
		final IResult<Boolean> r2 = this.wrapper.invokeSetOperation (RiakPBDriverTest.keyPrefix, k2, b2, handler2);
