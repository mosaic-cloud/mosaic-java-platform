...
public final class RiakOperationFactory
		implements
			IOperationFactory
{ // NOPMD
	private RiakOperationFactory (final String riakHost, final int riakPort, final String bucket, final boolean restCl)
	 ...
	 * @throws RiakException
	 */
	public static RiakOperationFactory getFactory (final String riakHost, final int port, final String bucket, final boolean restCl)
			throws RiakException
	{
