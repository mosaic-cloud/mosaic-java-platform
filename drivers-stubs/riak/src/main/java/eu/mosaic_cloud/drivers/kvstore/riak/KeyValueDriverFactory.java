...
public final class KeyValueDriverFactory
{
	 ...
	 */
	public static AbstractKeyValueDriver createDriver (final String driverName, final ConfigurationSource config, final ThreadingContext threadingContext)
		...
		if (type != null) {
			try {
				...
				final Method createMethod = driverClass.getMethod ("create", ConfigurationSource.class, ThreadingContext.class);
				try {
