...
/**
 * Driver class for the Riak key-value database management systems. Protocol Buffer Interface
 * 
			...
			extends AbstractKeyValueDriver
{
	...
	public synchronized void destroy () {
		super.destroy ();
		RiakPBDriver.logger.trace ("RiakDriver destroyed.");
	}
	 ...
	 */
	public static RiakPBDriver create (final ConfigurationSource config, final ThreadingContext threading)
		...
		noThreads = ConfigUtils.resolveParameter (config, ConfigProperties.KVStoreDriver_2, Integer.class, 1);
