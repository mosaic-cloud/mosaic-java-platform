 ...
 * @deprecated
 */
public final class RiakRestOperationFactory implements IOperationFactory {

    private RiakRestOperationFactory(final String riakHost, final int riakPort,
            final String bucket, final String clientId) {
        super();
        ...
        return new GenericOperation<Boolean>(new Callable<Boolean>() {
            ...
            public Boolean call() {
                ...
                final HttpResponse res = RiakRestOperationFactory.this.riakcl.delete(
                        RiakRestOperationFactory.this.bucket, key, meta);
    ...
    private IOperation<?> buildListOperation() {
        return new GenericOperation<List<String>>(new Callable<List<String>>() {
            ...
            public List<String> call() {
                final RequestMeta meta = new RequestMeta();
                meta.setClientId(RiakRestOperationFactory.this.clientId);
                final BucketResponse res = RiakRestOperationFactory.this.riakcl.listBucket(
                        RiakRestOperationFactory.this.bucket, meta);
     ...
     * @return the factory
     */
    public static RiakRestOperationFactory getFactory(final String riakHost, final int port,
            final String bucket, final String clientId) {
