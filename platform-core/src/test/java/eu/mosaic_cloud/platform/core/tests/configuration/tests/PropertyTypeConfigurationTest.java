...
public class PropertyTypeConfigurationTest {
    ...
    public void testConfigurationIdentifierResolve() {
        final ConfigurationIdentifier id0 = ConfigurationIdentifier
        ...
        final ConfigurationIdentifier id1 = ConfigurationIdentifier
        ...
        final ConfigurationIdentifier id2 = ConfigurationIdentifier
                .resolveRelative("boolean");
        Assert.assertNotNull(id2);
        Assert.assertEquals("Relative for non-root resolve relative failed",
                "boolean", id2.getIdentifier());
        final ConfigurationIdentifier id3 = ConfigurationIdentifier
                .resolveRelative(id0, "boolean");
    ...
    public void testGetParameter() {
        ...
        final Integer value = PropertyTypeConfigurationTest.configuration
        ...
        final Double dvalue = PropertyTypeConfigurationTest.configuration
        ...
        final Boolean bvalue = PropertyTypeConfigurationTest.configuration
        ...
        final String svalue = PropertyTypeConfigurationTest.configuration
    ...
    public void testSpliceConfiguration() {
        final IConfiguration mConfiguration = PropertyTypeConfigurationTest.configuration
                .spliceConfiguration(ConfigurationIdentifier
                        .resolveAbsolute("mosaic"));
        final int intValue = ConfigUtils.resolveParameter(mConfiguration,
                "int", Integer.class, 0);
        Assert.assertEquals(1, intValue);
        final String strValue = ConfigUtils.resolveParameter(mConfiguration,
                "string", String.class, "");
        Assert.assertEquals("abac", strValue);
        final boolean boolValue = ConfigUtils.resolveParameter(mConfiguration,
                "boolean", Boolean.class, false);
        Assert.assertTrue(boolValue);
        final double realValue = ConfigUtils.resolveParameter(mConfiguration,
                "real", Double.class, 0.0);
