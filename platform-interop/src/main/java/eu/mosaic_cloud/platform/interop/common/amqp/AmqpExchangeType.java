...
{
	/**
	 * With a direct exchange a message goes to the queues whose binding key exactly matches the routing key of the message.
	 */
	DIRECT ("direct"),
	/**
	...
	FANOUT ("fanout"),
	/**
	 * With a topic exchange a message goes to the queues whose binding key matches the routing key of the message.
	 */
	TOPIC ("topic");
	AmqpExchangeType (final String amqpName) {
