...
import eu.mosaic_cloud.platform.implementation.v2.connectors.interop.kvstore.BaseKvStoreConnectorProxy;
			...
			extends BaseKvStoreConnectorProxy<TValue>
{
	...
	public CallbackCompletion<Void> initialize (final CallbackCompletionTrigger<Void> trigger) {
		...
		return (this.connect (KeyValueSession.CONNECTOR, new Message (KeyValueMessage.ACCESS, requestBuilder.build ()), trigger));
	}
