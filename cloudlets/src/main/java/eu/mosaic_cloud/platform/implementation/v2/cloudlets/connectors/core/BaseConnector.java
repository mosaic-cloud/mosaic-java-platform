...
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorCallback.DestroyFailedArguments;
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorCallback.DestroySucceededArguments;
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorCallback.InitializeFailedArguments;
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorCallback.InitializeSucceededArguments;
 ...
 */
public abstract class BaseConnector<TConnector extends eu.mosaic_cloud.platform.v2.connectors.core.Connector, TCallback extends ConnectorCallback<TContext>, TContext extends Object>
			implements
				Connector,
				CallbackProxy
{
	protected BaseConnector (final CloudletController<?> cloudlet, final TConnector connector, final ConfigurationSource configuration, final TCallback callback, final TContext context) {
		super ();
