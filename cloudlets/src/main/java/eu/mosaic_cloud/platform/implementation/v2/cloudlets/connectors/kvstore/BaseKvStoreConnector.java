...
{
	protected BaseKvStoreConnector (final CloudletController<?> cloudlet, final TConnector connector, final ConfigurationSource config, final TCallback callback, final TContext context) {
