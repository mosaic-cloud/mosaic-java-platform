...
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.queue.amqp.AmqpQueueConsumerConnectorCallback.AcknowledgeFailedArguments;
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.queue.amqp.AmqpQueueConsumerConnectorCallback.AcknowledgeSucceededArguments;
import eu.mosaic_cloud.platform.v2.cloudlets.connectors.queue.amqp.AmqpQueueConsumerConnectorCallback.ConsumeArguments;
...
public class AmqpQueueConsumerConnector<TContext, TMessage, TExtra>
			extends BaseAmqpQueueConnector<eu.mosaic_cloud.platform.v2.connectors.queue.amqp.AmqpQueueConsumerConnector<TMessage>, AmqpQueueConsumerConnectorCallback<TContext, TMessage, TExtra>, TContext>
			implements
				eu.mosaic_cloud.platform.v2.cloudlets.connectors.queue.amqp.AmqpQueueConsumerConnector<TMessage, TExtra>
{
	@SuppressWarnings ("synthetic-access")
	public AmqpQueueConsumerConnector (final CloudletController<?> cloudlet, final eu.mosaic_cloud.platform.v2.connectors.queue.amqp.AmqpQueueConsumerConnector<TMessage> connector, final Configuration configuration, final AmqpQueueConsumerConnectorCallback<TContext, TMessage, TExtra> callback, final TContext context, final Callback<TMessage> backingCallback) {
