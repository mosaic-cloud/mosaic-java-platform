...
import eu.mosaic_cloud.platform.v2.cloudlets.core.CloudletCallback.DestroyArguments;
import eu.mosaic_cloud.platform.v2.cloudlets.core.CloudletCallback.DestroyFailedArguments;
...
public final class Cloudlet<TContext extends Object>
{
	...
	private final eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorsFactory provideConnectorsFactory () {
		...
		for (final Object initializer : initializers) {
			if (initializer instanceof eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorsFactoryInitializer) {
				try {
					builder.initialize ((eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorsFactoryInitializer) initializer);
				} catch (final Throwable exception) {
			...
			} else if (initializer instanceof eu.mosaic_cloud.platform.v2.connectors.core.ConnectorsFactoryInitializer) {
				try {
					builder.initialize ((eu.mosaic_cloud.platform.v2.connectors.core.ConnectorsFactoryInitializer) initializer);
				} catch (final Throwable exception) {
					this.exceptions.traceHandledException (exception);
					throw (new IllegalArgumentException ("error encountered while initializing cloudlet connectors factory", exception));
				}
		...
		final eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorsFactory factory;
		try {
	...
	private final ConnectorsFactoryBuilder provideConnectorsFactoryBuilder () {
		...
		final ConnectorsFactoryBuilder builder = this.provideConnectorsFactoryObject (ConnectorsFactoryBuilder.class, className, new Class<?>[] {CloudletController.class, ConnectorEnvironment.class, eu.mosaic_cloud.platform.v2.connectors.core.ConnectorsFactory.class}, new Object[] {this.controllerProxy, this.environment.getConnectorEnvironment (), this.environment.getConnectors ()});
		return builder;
	}
	...
	private final eu.mosaic_cloud.platform.v2.cloudlets.connectors.core.ConnectorsFactory connectorsFactoryDelegate;
	...
	final class ConnectorFactory<TFactory extends eu.mosaic_cloud.platform.v2.connectors.core.ConnectorFactory<?>>
				implements
					InvocationHandler
	{
