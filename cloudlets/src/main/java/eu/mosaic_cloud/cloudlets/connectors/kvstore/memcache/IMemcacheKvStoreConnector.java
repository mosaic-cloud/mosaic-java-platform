 ...
 *            correlation
 */
public interface IMemcacheKvStoreConnector<TValue, TExtra extends MessageEnvelope>
		extends
			IKvStoreConnector<TValue, TExtra>,
			eu.mosaic_cloud.connectors.kvstore.memcache.IMemcacheKvStoreConnector<TValue, TExtra>
{}
