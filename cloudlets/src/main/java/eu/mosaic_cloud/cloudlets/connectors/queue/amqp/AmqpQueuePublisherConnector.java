...
public class AmqpQueuePublisherConnector<TContext, TMessage, TExtra extends MessageEnvelope>
		extends BaseAmqpQueueConnector<eu.mosaic_cloud.connectors.queue.amqp.IAmqpQueuePublisherConnector<TMessage, TExtra>, IAmqpQueuePublisherConnectorCallback<TContext, TMessage, TExtra>, TContext>
		implements
			IAmqpQueuePublisherConnector<TMessage, TExtra>
{
	public AmqpQueuePublisherConnector (final ICloudletController<?> cloudlet, final eu.mosaic_cloud.connectors.queue.amqp.IAmqpQueuePublisherConnector<TMessage, TExtra> connector, final IConfiguration configuration, final IAmqpQueuePublisherConnectorCallback<TContext, TMessage, TExtra> callback, final TContext context)
	{
	...
	{
		final CallbackCompletion<Void> completion = this.connector.publish (message, extra);
