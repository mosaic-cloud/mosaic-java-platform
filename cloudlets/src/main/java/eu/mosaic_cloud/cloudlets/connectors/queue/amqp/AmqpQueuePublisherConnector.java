...
public class AmqpQueuePublisherConnector<TContext, TMessage, TExtra extends MessageEnvelope>
        extends
        BaseAmqpQueueConnector<eu.mosaic_cloud.connectors.queue.amqp.IAmqpQueuePublisherConnector<TMessage, TExtra>, IAmqpQueuePublisherConnectorCallback<TContext, TMessage, TExtra>, TContext>
    ...
    public AmqpQueuePublisherConnector(
            ...
            final eu.mosaic_cloud.connectors.queue.amqp.IAmqpQueuePublisherConnector<TMessage, TExtra> connector,
