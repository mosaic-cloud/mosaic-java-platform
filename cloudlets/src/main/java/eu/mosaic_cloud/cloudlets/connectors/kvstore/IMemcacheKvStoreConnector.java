 ...
 */
public interface IMemcacheKvStoreConnector<C, D, E> extends IKvStoreConnector<C, D, E>, eu.mosaic_cloud.connectors.kvstore.memcache.IMemcacheKvStoreConnector<D> {
