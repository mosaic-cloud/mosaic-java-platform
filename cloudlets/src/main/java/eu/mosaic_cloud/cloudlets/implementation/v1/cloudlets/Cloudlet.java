...
package eu.mosaic_cloud.cloudlets.implementation.v1.cloudlets;
...
import eu.mosaic_cloud.cloudlets.implementation.v1.cloudlets.CloudletFsm.FsmCallbackCompletionTransaction;
import eu.mosaic_cloud.cloudlets.implementation.v1.cloudlets.CloudletFsm.FsmState;
import eu.mosaic_cloud.cloudlets.implementation.v1.cloudlets.CloudletFsm.FsmTransition;
import eu.mosaic_cloud.cloudlets.implementation.v1.connectors.components.ComponentConnectorFactory;
import eu.mosaic_cloud.cloudlets.implementation.v1.connectors.core.DefaultConnectorsFactory;
	...
	private final IConnectorsFactory provideConnectorsFactory ()
	{
		...
		for (final Object initializer : initializers) {
			if (initializer instanceof eu.mosaic_cloud.cloudlets.v1.connectors.core.IConnectorsFactoryInitializer) {
				try {
					builder.initialize ((eu.mosaic_cloud.cloudlets.v1.connectors.core.IConnectorsFactoryInitializer) initializer);
				} catch (final Throwable exception) {
