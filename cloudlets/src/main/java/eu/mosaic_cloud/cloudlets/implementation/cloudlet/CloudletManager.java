...
public final class CloudletManager
{
	private CloudletManager (final IConfiguration configuration, final ClassLoader classLoader, final CallbackReactor reactor, final ThreadingContext threading, final ExceptionTracer exceptions, final ChannelFactory channelFactory, final ChannelResolver channelResolver)
	{
		...
		synchronized (this.monitor) {
			...
			{
				this.cloudletConfiguration = this.resolveCloudletConfiguration ();
				this.cloudletCallbacksClass = this.resolveCloudletCallbacksClass ();
	...
	private final Cloudlet<?> createCloudletInstance ()
	{
		...
		final CloudletEnvironment environment = CloudletEnvironment.create (this.cloudletConfiguration, this.cloudletCallbacksClass, this.cloudletContextClass, this.classLoader, connectorFactory, this.reactor, this.threading, this.exceptions);
