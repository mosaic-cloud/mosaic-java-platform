...
public final class CloudletComponent extends Object {
    ...
    final class ChannelFactoryHandler extends Object implements ChannelFactoryAndResolver,
            CallbackHandler {
        ...
        public final void resolve(final String target, final ResolverCallbacks callbacks) {
            ...
            final ComponentCallRequest request = ComponentCallRequest.create(operation, null,
                    reference);
            ...
            CloudletComponent.this.fsm.new FsmFutureCompletionAccess<ComponentCallReply>() {
                ...
                protected Void execute(final Future<ComponentCallReply> future1) {
                    ...
                    try {
                        callbacks.resolved(CloudletComponent.this.channelFactoryProxy, target,
                                peerIdentifier, peerEndpoint);
                    } catch (final Throwable exception) {
                        CloudletComponent.this.exceptions.traceHandledException(exception);
                        return (null);
                    }
    ...
    final class ComponentCallbacksHandler extends Object implements ComponentCallbacks,
            CallbackHandler {

        @Override
        public final CallbackCompletion<Void> called(final ComponentController component,
            ...
            return (CloudletComponent.this.fsm.new FsmCallbackAccess() {
                ...
                protected CallbackCompletion<Void> execute() {
                    ...
                    final ComponentCallReply reply = ComponentCallReply.create(false,
                            "unsupported call", request.reference);
        ...
        @Override
        public final CallbackCompletion<Void> callReturned(final ComponentController component,
                final ComponentCallReply reply) {
            return (CloudletComponent.this.fsm.new FsmCallbackAccess() {
        ...
        @Override
        public final CallbackCompletion<Void> casted(final ComponentController component,
        ...
        @Override
        public final CallbackCompletion<Void> failed(final ComponentController component,
            ...
            return (CloudletComponent.this.fsm.new FsmCallbackTransaction(
                ...
                protected StateAndOutput<FsmState, CallbackCompletion<Void>> execute() {
                    CloudletComponent.this.reactor.assignDelegate(
                            CloudletComponent.this.componentControllerProxy, component);
        ...
        @Override
        public final CallbackCompletion<Void> registerReturned(final ComponentController component,
    ...
    public static final class ComponentCallbacksProvider extends Object implements
    ...
    private CloudletComponent(final ComponentEnvironment componentEnvironment) {
        ...
        try {
            ...
            }
            {
                ...
                this.channel = ZeroMqChannel.create(this.channelIdentifier, this.threading,
                        this.exceptions);
                this.manager = CloudletManager.create(this.configuration, this.classLoader,
                        this.reactor, this.threading, this.exceptions, this.channelFactoryProxy,
    ...
    private final IConfiguration resolveConfiguration() {
        final String configurationDescriptor = this.componentEnvironment.supplementary.get(
                "descriptor", String.class, null); //$NON-NLS-1$
        Preconditions.checkNotNull(configurationDescriptor,
                "unknown cloudlet component configuration descriptor");
        this.transcript.traceDebugging("resolving cloudlet configuration: `%s`...",
        ...
        try {
            ...
            throw (new IllegalArgumentException(
                    "error encountered while loading cloudlet component configuration", exception));
        }
