 ...
 * 
 */
public final class CloudletComponent extends Object {

    final class ChannelFactoryHandler extends Object implements
            ChannelFactoryAndResolver, CallbackHandler {
        ...
        public final void failedCallbacks(final Callbacks proxy,
            ...
            Preconditions
                    .checkState(proxy == CloudletComponent.this.componentCallbacksProxy);
        ...
        public final void registeredCallbacks(final Callbacks proxy,
            ...
            CloudletComponent.this.fsm.new FsmVoidTransaction(
                    FsmTransition.RegisterCompleted) {

                @Override
                protected StateAndOutput<FsmState, Void> execute() {
                    return (CloudletComponent.this.componentCallbacksHandler
                            .registerCallbacksExecute());
                }
            }.trigger();
        }

        @Override
        public final void resolve(final String target,
                final ResolverCallbacks callbacks) {
            Preconditions.checkNotNull(target);
            Preconditions.checkNotNull(callbacks);
            // FIXME: This should be done in `Active` state
            // FIXME: This should be done in an `FsmAccess`
            final ComponentIdentifier identifier = ComponentIdentifier
                    .resolve(target);
            final String operation = ConfigProperties
                    .getString("CloudletComponent.7");
            final ComponentCallReference reference = ComponentCallReference
                    .create();
            final ComponentCallRequest request = ComponentCallRequest.create(
                    operation, null, reference);
            final DeferredFuture<ComponentCallReply> future = DeferredFuture
                    .create(ComponentCallReply.class);
            CloudletComponent.this.componentControllerProxy.call(identifier,
                    request);
            CloudletComponent.this.componentPendingOutboundCalls.put(reference,
                    future.trigger);
            CloudletComponent.this.fsm.new FsmFutureCompletionAccess<ComponentCallReply>() {
                ...
                protected Void execute(final Future<ComponentCallReply> future1) {
                    ...
                    try {
                        ...
                        CloudletComponent.this.exceptions
                    ...
                    final String peerIdentifierKey = ConfigProperties
                            .getString("CloudletComponent.13");
                    final String peerEndpointKey = ConfigProperties
                            .getString("CloudletComponent.12");
                    final String peerIdentifier;
                    final String peerEndpoint;
                    try {
                        peerIdentifier = (String) ((Map<String, Object>) reply.outputsOrError)
                                .get(peerIdentifierKey);
                        peerEndpoint = (String) ((Map<String, Object>) reply.outputsOrError)
                                .get(peerEndpointKey);
                    } catch (final Throwable exception) {
                        CloudletComponent.this.exceptions
                                .traceHandledException(exception);
                    ...
                    try {
                        callbacks.resolved(
                                CloudletComponent.this.channelFactoryProxy,
                                target, peerIdentifier, peerEndpoint);
                    } catch (final Throwable exception) {
                        CloudletComponent.this.exceptions
                                .traceHandledException(exception);
                        return (null);
        ...
        public final void unregisteredCallbacks(final Callbacks proxy) {
            CloudletComponent.this.fsm.new FsmVoidTransaction(
                    FsmTransition.UnregisterCompleted) {

                @Override
                protected StateAndOutput<FsmState, Void> execute() {
                    return (CloudletComponent.this.componentCallbacksHandler
                            .unregisterCallbacksExecute());
                }
            }.trigger();
        }
    }

    final class ComponentCallbacksHandler extends Object implements
            ComponentCallbacks, CallbackHandler {

        @Override
        public final CallbackCompletion<Void> called(
            ...
            return (CloudletComponent.this.fsm.new FsmCallbackAccess() {
                ...
                protected CallbackCompletion<Void> execute() {
                    ...
                    final ComponentCallReply reply = ComponentCallReply.create(
                            false, "unsupported call", request.reference);
                    CloudletComponent.this.componentControllerProxy
                            .callReturn(reply);
        ...
        @Override
        public final CallbackCompletion<Void> callReturned(
                final ComponentController component,
                final ComponentCallReply reply) {
            return (CloudletComponent.this.fsm.new FsmCallbackAccess() {
                ...
                @Override
                protected CallbackCompletion<Void> execute() {
                    final Trigger<ComponentCallReply> trigger = CloudletComponent.this.componentPendingOutboundCalls
        ...
        @Override
        public final CallbackCompletion<Void> casted(
                final ComponentController component,
        ...
        @Override
        public final CallbackCompletion<Void> failed(
                final ComponentController component, final Throwable exception) {
        ...
        @Override
        public final CallbackCompletion<Void> initialized(
                final ComponentController component) {
            return (CloudletComponent.this.fsm.new FsmCallbackTransaction(
                    FsmTransition.InitializeCompleted) {

                @Override
                protected StateAndOutput<FsmState, CallbackCompletion<Void>> execute() {
                    CloudletComponent.this.reactor.assignDelegate(
                            CloudletComponent.this.componentControllerProxy,
                            component);
                    // FIXME: this should be asynchronous and handled as part of
                    // the life-cycle
                    CloudletComponent.this.manager.createInstance();
                    return (StateAndOutput.create(FsmState.Active,
                            CallbackCompletion.createOutcome()));
                }
            }.trigger());
        }
        ...
        public final void registeredCallbacks(final Callbacks proxy,
            ...
            CloudletComponent.this.fsm.new FsmVoidTransaction(
                ...
                @Override
                protected StateAndOutput<FsmState, Void> execute() {
                    return (ComponentCallbacksHandler.this
                            .registerCallbacksExecute());
                }
            }.trigger();
        }
        ...
        @Override
        public final CallbackCompletion<Void> registerReturned(
                final ComponentController component,
        ...
        @Override
        public final CallbackCompletion<Void> terminated(
                final ComponentController component) {
            return (CloudletComponent.this.fsm.new FsmCallbackTransaction(
                ...
                @Override
                protected StateAndOutput<FsmState, CallbackCompletion<Void>> execute() {
                    CloudletComponent.this.reactor
                            .destroyProxy(CloudletComponent.this.componentControllerProxy);
                    CloudletComponent.this.reactor
                            .destroyProxy(CloudletComponent.this.componentCallbacksProxy);
                    CloudletComponent.this.reactor
                            .destroyProxy(CloudletComponent.this.channelFactoryProxy);
                    return (StateAndOutput.create(FsmState.UnregisterPending2,
                            null));
                }
            }.trigger());
        }
        ...
        final StateAndOutput<FsmState, Void> unregisterCallbacksExecute() {
            ...
            case UnregisterPending2:
                return (StateAndOutput
                        .create(FsmState.UnregisterPending1, null));
    ...
    public static final class ComponentCallbacksProvider extends Object
            implements
            eu.mosaic_cloud.components.core.ComponentCallbacksProvider {

        @Override
        public final ComponentCallbacks provide(
                final ComponentEnvironment context) {
            final CloudletComponent component = CloudletComponent
                    .create(context);
    ...
    public static final CloudletComponent create(
            final ComponentEnvironment context) {
    ...
    private CloudletComponent(final ComponentEnvironment componentEnvironment) {
        ...
        }
        {
            ...
            this.exceptions = TranscriptExceptionTracer.create(this.transcript,
                    this.componentEnvironment.exceptions);
        ...
        try {
            ...
            }
            {
                ...
                this.componentCallbacksProxy = this.reactor
                        .createProxy(ComponentCallbacks.class);
                this.componentControllerProxy = this.reactor
                        .createProxy(ComponentController.class);
                this.channelFactoryProxy = this.reactor
                        .createProxy(ChannelFactoryAndResolver.class);
            }
            {
                this.channelIdentifier = UUID.randomUUID().toString();
                this.channel = ZeroMqChannel.create(this.channelIdentifier,
                        this.threading, this.exceptions);
                this.manager = CloudletManager.create(this.configuration,
                        this.classLoader, this.reactor, this.threading,
                        this.exceptions, this.channelFactoryProxy,
                        this.channelFactoryProxy);
            }
            {
            ...
            {
                CloudletComponent.this.reactor.assignHandler(
                        CloudletComponent.this.componentCallbacksProxy,
                        CloudletComponent.this.componentCallbacksHandler,
                        CloudletComponent.this.isolate);
                CloudletComponent.this.reactor.assignHandler(
                        CloudletComponent.this.channelFactoryProxy,
                        CloudletComponent.this.channelFactoryHandler,
                        CloudletComponent.this.isolate);
            }
    ...
    private final void handleInternalFailure(final Callbacks proxy,
            final Throwable exception) {
    ...
    private final IConfiguration resolveConfiguration() {
        final String configurationDescriptor = this.componentEnvironment.supplementary
        ...
        try {
            ...
            throw (new IllegalArgumentException(
                    "error encountered while loading cloudlet component configuration",
                    exception));
        }
    ...
    private final ComponentIdentifier resolveSelfGroup() {
        final String groupName = ConfigUtils
                .resolveParameter(
                        this.configuration,
                        ConfigProperties.getString("CloudletComponent.3"), String.class, ConfigProperties.getString("CloudletComponent.14")); //$NON-NLS-1$ 
        Preconditions.checkNotNull(groupName,
                "unknown cloudlet component self group");
        final ComponentIdentifier group = ComponentIdentifier
                .resolve(groupName);
        return (group);
    }
}
