...
package eu.mosaic_cloud.cloudlets.implementations.v1.components;


import java.util.concurrent.Executor;
import java.util.concurrent.Future;

import eu.mosaic_cloud.cloudlets.implementations.v1.components.CloudletComponentFsm.FsmState;
import eu.mosaic_cloud.cloudlets.implementations.v1.components.CloudletComponentFsm.FsmTransition;
...
{
	protected CloudletComponentFsm (final CloudletComponent component, final Transcript transcript, final ExceptionTracer exceptions) {
