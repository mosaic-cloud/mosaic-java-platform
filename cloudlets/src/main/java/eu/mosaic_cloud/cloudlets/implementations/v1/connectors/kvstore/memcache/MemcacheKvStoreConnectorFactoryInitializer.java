...
package eu.mosaic_cloud.cloudlets.implementations.v1.connectors.kvstore.memcache;
...
import eu.mosaic_cloud.cloudlets.v1.connectors.kvstore.memcache.IMemcacheKvStoreConnector;
import eu.mosaic_cloud.cloudlets.v1.connectors.kvstore.memcache.IMemcacheKvStoreConnectorCallback;
import eu.mosaic_cloud.cloudlets.v1.connectors.kvstore.memcache.IMemcacheKvStoreConnectorFactory;
		...
		extends BaseConnectorsFactoryInitializer
{
	...
	protected void initialize_1 (final IConnectorsFactoryBuilder builder, final ICloudletController<?> cloudlet, final ConnectorEnvironment environment, final IConnectorsFactory delegate)
	{
		...
		builder.register (IMemcacheKvStoreConnectorFactory.class, new IMemcacheKvStoreConnectorFactory () {
			...
			{
				final eu.mosaic_cloud.connectors.implementations.v1.kvstore.memcache.MemcacheKvStoreConnector<TValue> backingConnector = (eu.mosaic_cloud.connectors.implementations.v1.kvstore.memcache.MemcacheKvStoreConnector<TValue>) delegate.getConnectorFactory (eu.mosaic_cloud.connectors.v1.kvstore.memcache.IMemcacheKvStoreConnectorFactory.class).create (configuration, valueClass, valueEncoder);
