			...
			extends CallbackArguments
{
	 ...
	 */
	public AmqpQueueConsumeCallbackArguments (final ICloudletController<?> cloudlet, final AmqpMessageToken token, final TMessage message) {
		super (cloudlet);
	...
	public AmqpMessageToken getToken () {
		return this.token;
	}
	
	private final TMessage message;
	private final AmqpMessageToken token;
}
