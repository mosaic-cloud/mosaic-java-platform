			...
			extends CallbackArguments
{
	 ...
	 */
	public CallbackCompletionArguments (final CloudletController<?> cloudlet) {
		super (cloudlet);
	}
	 ...
	 */
	public CallbackCompletionArguments (final CloudletController<?> cloudlet, final Throwable error) {
		super (cloudlet);
		this.error = error;
	}
