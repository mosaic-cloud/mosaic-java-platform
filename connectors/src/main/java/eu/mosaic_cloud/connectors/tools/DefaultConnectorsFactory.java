...
public class DefaultConnectorsFactory extends BaseConnectorsFactory {
    ...
    protected static final void initialize(final DefaultConnectorsFactory factory,
        ...
        factory.registerFactory(IKvStoreConnectorFactory.class, new IKvStoreConnectorFactory() {
            ...
            @Override
            public <TValue, TExtra extends MessageEnvelope> IKvStoreConnector<TValue, TExtra> create(
        ...
        factory.registerFactory(IMemcacheKvStoreConnectorFactory.class,
                new IMemcacheKvStoreConnectorFactory() {
                    ...
                    @Override
                    public <TValue, TExtra extends MessageEnvelope> IMemcacheKvStoreConnector<TValue, TExtra> create(
                            final IConfiguration configuration, final Class<TValue> valueClass,
                            final DataEncoder<TValue> valueEncoder) {
        ...
        factory.registerFactory(IAmqpQueuePublisherConnectorFactory.class,
                new IAmqpQueuePublisherConnectorFactory() {
                    ...
                    @Override
                    public <TMessage, TExtra extends MessageEnvelope> IAmqpQueuePublisherConnector<TMessage,TExtra> create(
                            final IConfiguration configuration, final Class<TMessage> messageClass,
                            final DataEncoder<TMessage> messageEncoder) {
        ...
        factory.registerFactory(IHttpgQueueConnectorFactory.class,
                new IHttpgQueueConnectorFactory() {
                    ...
                    @Override
                    public <TRequestBody, TResponseBody> IHttpgQueueConnector<TRequestBody, TResponseBody> create(
                            ...
                            final IHttpgQueueCallback<TRequestBody, TResponseBody> callback) {
                        return HttpgQueueConnector.create(
                                ConnectorConfiguration.create(configuration, environment),
                                requestBodyClass, requestBodyEncoder, responseBodyClass,
                                responseBodyEncoder, callback);
                    }
                });
    }
}
