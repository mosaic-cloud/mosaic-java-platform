 ...
 * 
 */
public class BaseKvStoreConnectorProxy<T extends Object>
		extends BaseConnectorProxy
{
	protected BaseKvStoreConnectorProxy (final IConfiguration configuration, final Channel channel, final DataEncoder<T> encoder)
	{
	...
	protected CallbackCompletion<Boolean> sendSetMessage (final String key, final T data, final int exp)
	{
		final CompletionToken token = this.generateToken ();
