...
public interface IAmqpQueueRawConnector extends IAmqpQueueConnector
{
    /**
     ...
     */
    CallbackCompletion<Boolean> bindQueue(final String exchange, final String queue,
     ...
     */
    CallbackCompletion<Boolean> declareExchange(final String name, final AmqpExchangeType type,
     ...
     */
    CallbackCompletion<Boolean> declareQueue(final String queue, final boolean exclusive,
            final boolean durable, final boolean autoDelete, final boolean passive);
