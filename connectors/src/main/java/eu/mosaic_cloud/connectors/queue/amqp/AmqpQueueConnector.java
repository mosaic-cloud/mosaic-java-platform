 ...
 * 
 */
public class AmqpQueueConnector
		extends BaseConnector<AmqpQueueConnectorProxy>
		implements
			IAmqpQueueConnector
{
	 ...
	 * @throws Throwable
	 */
	public static AmqpQueueConnector create (final IConfiguration configuration, final ThreadingContext threading)
	{
		...
		final AmqpQueueConnectorProxy proxy = AmqpQueueConnectorProxy.create (configuration, driverIdentity, channel);
