...
public final class AmqpQueueRawConnectorProxy extends BaseConnectorProxy
    ...
    protected void processResponse(final Message message) { 
        ...
        case CANCEL_OK: {
            ...
            this.logger.debug("QueueConnectorProxy - Received CANCEL_OK "
        ...
        case SERVER_CANCEL: {
            ...
            this.logger.debug("QueueConnectorProxy - Received SERVER_CANCEL "
                    + " for consumer " + consumerId);
        ...
        case CONSUME_OK: {
            ...
            this.logger.debug("QueueConnectorProxy - Received CONSUME_OK "
                    + " for consumer " + consumerId);
            final IAmqpQueueRawConsumerCallback callback = this.pendingConsumers
                    .get(consumerId);
        ...
        case DELIVERY: {
            ...
            this.logger.debug("QueueConnectorProxy - Received DELIVERY "
                    + " for consumer " + consumerId);
        ...
        case SHUTDOWN: {
            ...
            this.logger.debug("QueueConnectorProxy - Received SHUTDOWN "
                    + " for consumer " + consumerId);
