...
public final class AmqpQueueConsumerConnectorProxy<TMessage> extends
    ...
    private AmqpQueueConsumerConnectorProxy(final AmqpQueueRawConnectorProxy rawProxy,
        ...
        this.queue = configuration.getConfigParameter(ConfigProperties
                .getString("AmqpQueueConnector.2"), String.class, this.raw.getIdentifier()); //$NON-NLS-1$ 
        ...
        this.bindingRoutingKey = configuration.getConfigParameter(ConfigProperties
